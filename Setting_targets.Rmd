...
There are 9 interventions we will consider in this list:  
```{r}
...
sims <- list(
  ...
  simulator(df_2030, country, interventions[[3]], "Pop_wra", "Pop_anaemic"), # Deworming tablets in WRA
  simulator(df_2030, country, interventions[[4]], "Pop_total", "Pop_anaemic") # Staple food supplementation for all
)
